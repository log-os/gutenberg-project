...
public class OnixGenerator {
    ...
    public DescriptiveDetail buildDescriptiveDetail(String title, String subTitle, String author, List<String> subjects, String language) {
        ...
        if (language != null && !language.isEmpty()) {
            LanguageUtil languageUtil = LanguageUtil.byEpubCode(language);
            if (languageUtil != null) {
                LanguageCode languageCode = new LanguageCode();
                languageCode.setValue(languageUtil.onixCode);
                Language lang = new Language();
                lang.setLanguageCode(languageCode);
                LanguageRole languageRole = new LanguageRole();
                languageRole.setValue("01");
                lang.setLanguageRole(languageRole);
